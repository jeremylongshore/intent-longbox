...
**Sixty-seven tables, sixty-seven owners, no table owned twice and none unowned** (v1.3.1: **thirty-seven created, thirty not yet created** — v1.3.0 read sixty-one tables, thirty-one created; this row adds the six workflow/platform tables below, all created, none new to any module's ownership).
