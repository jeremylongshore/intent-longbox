...
- **Cards:** `set` + `number` + `variant` + `language` (per the E02-B04 brief and 014 §3.4's "identity schema and exact keys"; `grader` left this list at v1.2.1 — it is a copy fact, per 047 A6 and §5.4 below).
