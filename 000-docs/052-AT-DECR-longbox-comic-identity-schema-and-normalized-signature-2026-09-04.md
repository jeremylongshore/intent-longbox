...
**Version:** 1.0.2
**Status:** **RATIFIED 2026-09-04 (v1.0.2)** by the acting head under Jeremy's standing delegation — `longbox-gate-auditor` NOT-READY at `d217225` (two evidence defects, seven repairs, no decision wrong) → READY-TO-CLOSE at `60cae02`. Every decision here was taken and merged in E04-B02 (PR #69, `f6adbc4`); this record lifts them into citable form and may be cited as settled from this version.
...
|---|---|---|---|
| 1.0.2 | 2026-09-04 | **Ratified.** The gate re-audit at `60cae02` returned READY-TO-CLOSE; the Status line is the only change. | acting head |
