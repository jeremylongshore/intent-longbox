...
**Sensitivity:** Restricted internal when written, public since 2026-09-15 (014 §10). It names no shop, no person and no secret value. It describes the shape of every credential this system holds and the blast radius of losing one of them, which is a map of the design and not of anybody's data.
