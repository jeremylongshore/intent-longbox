...
**Sensitivity:** Restricted internal when written, public since 2026-09-15 (014 §10). It names tables, columns, headers, topics and two provisional numbers. It contains no shop, no store, no person, no customer and no credential value, and it never will.
