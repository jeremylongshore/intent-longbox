...
-- The schema and seed of intent-longbox at migration 023, dumped with
--   pnpm fixture:schema --upto 023 --out tests/fixtures/schema/after-023.sql
...
\restrict V4RrRHj4xM17ZQRLZoa22ViqSybqxIDCoNGkTZHzIIDxtcCtezAaiA4VfCshn6E
...
CREATE TABLE "public"."auth_attempt" (
    ...
    CONSTRAINT "auth_attempt_method_check" CHECK (("method" = ANY (ARRAY['operator_pin'::"text", 'device_credential'::"text", 'session_token'::"text", 'password'::"text", 'totp'::"text", 'invitation'::"text", 'enrollment_code'::"text"])))
);
...
\unrestrict V4RrRHj4xM17ZQRLZoa22ViqSybqxIDCoNGkTZHzIIDxtcCtezAaiA4VfCshn6E
