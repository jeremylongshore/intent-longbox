...
-- The schema and seed of intent-longbox at migration 030, dumped with
--   pnpm fixture:schema --upto 030 --out tests/fixtures/schema/after-030.sql
...
\restrict Wqxu5fECgKdby96lNG4mKuOmbk2Zo39NAi8vyXHguSAFDiKIlGgd5N1qgCtoIDv
...
CREATE TABLE "public"."app_session" (
    ...
    CONSTRAINT "app_session_kind_check" CHECK (("kind" = ANY (ARRAY['device'::"text", 'operator'::"text"]))),
    CONSTRAINT "app_session_kind_shape" CHECK (((("kind" = 'device'::"text") AND ("app_user_id" IS NULL) AND ("parent_session_id" IS NULL) AND ("parent_chain_id" IS NULL)) OR (("kind" = 'operator'::"text") AND ("app_user_id" IS NOT NULL) AND ("parent_session_id" IS NOT NULL) AND ("parent_chain_id" IS NOT NULL)))),
...
CREATE TABLE "public"."app_session_revocation" (
    ...
    CONSTRAINT "app_session_revocation_reason_check" CHECK (("reason" = ANY (ARRAY['signed_out'::"text", 'token_reuse'::"text", 'membership_change'::"text", 'device_revoked'::"text", 'operator_switch'::"text"])))
);
...
\unrestrict Wqxu5fECgKdby96lNG4mKuOmbk2Zo39NAi8vyXHguSAFDiKIlGgd5N1qgCtoIDv
