...
-- The schema and seed of intent-longbox at migration 035, dumped with
--   pnpm fixture:schema --upto 035 --out tests/fixtures/schema/after-035.sql
...
\restrict SInuFSEx8hXbPsXwcflkY5jWEuqgXZjIFTM57T4sXmJiAgqosN33dZcAUZm4HJN
...
--
-- Name: check_origin_designation_window(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."check_origin_designation_window"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
...
--
-- Name: forbid_authenticator_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."forbid_authenticator_mutation"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
--
-- Name: forbid_credential_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."forbid_credential_mutation"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF TG_OP = 'DELETE' THEN
...
--
-- Name: force_origin_retirement_now(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."force_origin_retirement_now"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
--
-- Name: longbox_is_origin_staff("uuid", timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."longbox_is_origin_staff"("p_app_user_id" "uuid", "p_at" timestamp with time zone) RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  SELECT EXISTS (
    SELECT 1
...
--
-- Name: longbox_service(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."longbox_service"() RETURNS boolean
    LANGUAGE "sql" STABLE PARALLEL SAFE
    AS $$
...
--
-- Name: longbox_service_scope(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."longbox_service_scope"() RETURNS "text"
    LANGUAGE "sql" STABLE PARALLEL SAFE
    AS $$
...
CREATE TABLE "public"."app_session" (
    ...
    CONSTRAINT "app_session_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "app_session_kind_is_known" CHECK (("kind" = ANY (ARRAY['device'::"text", 'operator'::"text", 'privileged'::"text"]))),
    CONSTRAINT "app_session_kind_shape" CHECK (((("kind" = 'device'::"text") AND ("app_user_id" IS NULL) AND ("parent_session_id" IS NULL) AND ("parent_chain_id" IS NULL) AND ("device_id" IS NOT NULL) AND ("device_credential_id" IS NOT NULL) AND ("location_id" IS NOT NULL)) OR (("kind" = 'operator'::"text") AND ("app_user_id" IS NOT NULL) AND ("parent_session_id" IS NOT NULL) AND ("parent_chain_id" IS NOT NULL) AND ("device_id" IS NOT NULL) AND ("device_credential_id" IS NOT NULL) AND ("location_id" IS NOT NULL)) OR (("kind" = 'privileged'::"text") AND ("app_user_id" IS NOT NULL) AND ("parent_session_id" IS NULL) AND ("parent_chain_id" IS NULL) AND ("device_id" IS NULL) AND ("device_credential_id" IS NULL)))),
    CONSTRAINT "app_session_rotation_is_not_self" CHECK (("rotated_from" IS DISTINCT FROM "id"))
);


--
-- Name: app_session_revocation; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."app_session_revocation" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "chain_id" "uuid" NOT NULL,
    ...
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "app_session_revocation_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "app_session_revocation_reason_is_known" CHECK (("reason" = ANY (ARRAY['signed_out'::"text", 'token_reuse'::"text", 'membership_change'::"text", 'device_revoked'::"text", 'operator_switch'::"text", 'mfa_reenrolled'::"text", 'privileged_superseded'::"text"])))
);
...
CREATE TABLE "public"."app_user" (
    ...
    CONSTRAINT "app_user_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'suspended'::"text", 'deactivated'::"text"])))
);


--
-- Name: app_user_origin; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."app_user_origin" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    CONSTRAINT "app_user_origin_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "app_user_origin_origin_check" CHECK (("origin" = 'longbox_staff'::"text")),
    CONSTRAINT "app_user_origin_reason_check" CHECK (("length"("btrim"("reason")) > 0))
);


--
-- Name: app_user_origin_retirement; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."app_user_origin_retirement" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "app_user_origin_retirement_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "app_user_origin_retirement_reason_check" CHECK (("length"("btrim"("reason")) > 0))
);
...
CREATE TABLE "public"."auth_attempt" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "auth_attempt_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "auth_attempt_method_is_known" CHECK (("method" = ANY (ARRAY['operator_pin'::"text", 'device_credential'::"text", 'session_token'::"text", 'password'::"text", 'totp'::"text", 'invitation'::"text", 'enrollment_code'::"text", 'recovery_code'::"text"])))
);


--
-- Name: authorization_decision; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."authorization_decision" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    ...
    "matrix_commit" "text" DEFAULT 'unknown'::"text" NOT NULL,
    "membership_id" "uuid",
    "role" "text",
    ...
    CONSTRAINT "authorization_decision_decision_check" CHECK (("decision" = ANY (ARRAY['allowed'::"text", 'refused'::"text"]))),
    CONSTRAINT "authorization_decision_membership_has_a_role" CHECK ((("membership_id" IS NULL) OR ("role" IS NOT NULL))),
    CONSTRAINT "authorization_decision_reason_matches_decision" CHECK (((("decision" = 'allowed'::"text") AND ("refusal_reason" IS NULL)) OR (("decision" = 'refused'::"text") AND ("refusal_reason" IS NOT NULL)))),
    CONSTRAINT "authorization_decision_refusal_reason_check" CHECK (("refusal_reason" = ANY (ARRAY['role'::"text", 'scope'::"text"]))),
    CONSTRAINT "authorization_decision_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'manager'::"text", 'operator'::"text", 'support_break_glass'::"text"]))),
    CONSTRAINT "authorization_decision_session_or_cli" CHECK ((("session_chain_id" IS NOT NULL) OR ("route_method" = 'CLI'::"text")))
);
...
CREATE TABLE "public"."condition_assessment" (
    ...
    "against_table" "text",
    "against_id" "uuid",
    CONSTRAINT "condition_assessment_against_table_check" CHECK ((("against_table" IS NULL) OR ("against_table" = ANY (ARRAY['scan_photo'::"text", 'candidate_set'::"text", 'llm_rerank'::"text", 'human_confirmation'::"text", 'condition_assessment'::"text", 'pricing_snapshot'::"text", 'shopify_draft'::"text", 'scan_session'::"text"])))),
    ...
    CONSTRAINT "condition_assessment_reference_is_whole" CHECK ((("against_table" IS NULL) = ("against_id" IS NULL))),
...
--
-- Name: connector_install_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."connector_install_state" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "connector_install_state_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "connector_install_state_connector_check" CHECK (("connector" = 'shopify'::"text")),
    CONSTRAINT "connector_install_state_expires_after_it_is_issued" CHECK (("expires_at" > "created_at"))
);


--
-- Name: connector_install_state_use; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."connector_install_state_use" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "state_id" "uuid" NOT NULL,
    "connector_token_version_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "connector_install_state_use_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: connector_token_retirement; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."connector_token_retirement" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "connector_token_version_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "connector_token_retirement_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "connector_token_retirement_reason_code_check" CHECK (("reason_code" = ANY (ARRAY['uninstall'::"text", 'rotation'::"text", 'revocation'::"text"]))),
    CONSTRAINT "connector_token_retirement_status_needs_its_attempt" CHECK ((("provider_revocation_http_status" IS NULL) OR ("provider_revocation_attempted_at" IS NOT NULL))),
    CONSTRAINT "connector_token_retirement_uninstall_cites_its_webhook" CHECK (((("reason_code" = 'uninstall'::"text") AND ("webhook_receipt_id" IS NOT NULL)) OR ("reason_code" <> 'uninstall'::"text")))
);


--
-- Name: connector_token_version; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."connector_token_version" (
    "id" "uuid" NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "connector" "text" NOT NULL,
    "shop_domain" "text" NOT NULL,
    "install_state_id" "uuid",
    ...
    CONSTRAINT "connector_token_version_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "connector_token_version_connector_check" CHECK (("connector" = 'shopify'::"text")),
    CONSTRAINT "connector_token_version_key_version_check" CHECK (("key_version" >= 1)),
    CONSTRAINT "connector_token_version_scopes_are_not_empty" CHECK (("array_length"("granted_scopes", 1) >= 1)),
    CONSTRAINT "connector_token_version_version_no_check" CHECK (("version_no" >= 1))
);


--
-- Name: connector_webhook_receipt; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."connector_webhook_receipt" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'provider'::"text" NOT NULL,
    CONSTRAINT "connector_webhook_receipt_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "connector_webhook_receipt_connector_check" CHECK (("connector" = 'shopify'::"text")),
    CONSTRAINT "connector_webhook_receipt_payload_bytes_check" CHECK (("payload_bytes" >= 0))
);
...
CREATE TABLE "public"."device" (
    ...
    "kind" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "device_kind_check" CHECK (("kind" = ANY (ARRAY['phone'::"text", 'kiosk'::"text", 'tablet'::"text"])))
);


--
-- Name: device_credential; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."device_credential" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "device_credential_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: device_credential_revocation; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."device_credential_revocation" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "device_credential_revocation_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: device_enrollment_code; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."device_enrollment_code" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "location_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "device_enrollment_code_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "device_enrollment_code_device_kind_check" CHECK (("device_kind" = ANY (ARRAY['phone'::"text", 'kiosk'::"text", 'tablet'::"text"]))),
    CONSTRAINT "device_enrollment_code_expires_after_it_is_issued" CHECK (("expires_at" > "created_at"))
);


--
-- Name: device_enrollment_code_use; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."device_enrollment_code_use" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "device_enrollment_code_use_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);
...
CREATE TABLE "public"."human_confirmation" (
    ...
    "against_table" "text",
    "against_id" "uuid",
    CONSTRAINT "human_confirmation_against_table_check" CHECK ((("against_table" IS NULL) OR ("against_table" = ANY (ARRAY['scan_photo'::"text", 'candidate_set'::"text", 'llm_rerank'::"text", 'human_confirmation'::"text", 'condition_assessment'::"text", 'pricing_snapshot'::"text", 'shopify_draft'::"text", 'scan_session'::"text"])))),
    ...
    CONSTRAINT "human_confirmation_reference_is_whole" CHECK ((("against_table" IS NULL) = ("against_id" IS NULL))),
...
--
-- Name: identity_access; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."identity_access" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid",
    "purpose" "text" NOT NULL,
    "accessor_method" "text" NOT NULL,
    "accessor_path" "text" NOT NULL,
    "key_kind" "text" NOT NULL,
    "resolved_count" integer NOT NULL,
    "build_commit" "text" DEFAULT 'unknown'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "date_trunc"('hour'::"text", "now"()) NOT NULL,
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "identity_access_accessor_method_check" CHECK (("length"("btrim"("accessor_method")) > 0)),
    CONSTRAINT "identity_access_accessor_path_check" CHECK (("length"("btrim"("accessor_path")) > 0)),
    CONSTRAINT "identity_access_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "identity_access_key_kind_check" CHECK (("key_kind" = ANY (ARRAY['app_user_id'::"text", 'operator_id'::"text", 'created_by'::"text", 'confirmed_by'::"text", 'membership_id'::"text", 'session_chain_id'::"text", 'shop_roster'::"text"]))),
    CONSTRAINT "identity_access_purpose_check" CHECK (("purpose" = ANY (ARRAY['session_display_name'::"text", 'operator_picker_roster'::"text", 'invitation_addressee'::"text", 'authenticator_enrollment'::"text"]))),
    CONSTRAINT "identity_access_resolved_count_check" CHECK (("resolved_count" >= 0)),
    CONSTRAINT "identity_access_unscoped_is_a_cli" CHECK ((("shop_id" IS NOT NULL) OR ("accessor_method" = 'CLI'::"text")))
);
...
CREATE TABLE "public"."invitation" (
    ...
    "app_user_id" "uuid" NOT NULL,
    "role" "text" NOT NULL,
    "scope_kind" "text" DEFAULT 'shop'::"text" NOT NULL,
    "location_id" "uuid",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "invitation_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "invitation_expires_after_it_is_issued" CHECK (("expires_at" > "created_at")),
    CONSTRAINT "invitation_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'manager'::"text", 'operator'::"text"]))),
    CONSTRAINT "invitation_scope_is_whole" CHECK (((("scope_kind" = 'shop'::"text") AND ("location_id" IS NULL)) OR (("scope_kind" = 'location'::"text") AND ("location_id" IS NOT NULL)))),
    CONSTRAINT "invitation_scope_kind_check" CHECK (("scope_kind" = ANY (ARRAY['shop'::"text", 'location'::"text"])))
);


--
-- Name: invitation_use; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."invitation_use" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "invitation_id" "uuid" NOT NULL,
    "membership_id" "uuid" NOT NULL,
    "redeemed_on_device_id" "uuid" NOT NULL,
    "redeemed_on_session_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "invitation_use_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);
...
CREATE TABLE "public"."location" (
    ...
    "country" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "location_kind_check" CHECK (("kind" = ANY (ARRAY['store'::"text", 'online'::"text"])))
);
...
CREATE TABLE "public"."membership" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "membership_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "membership_break_glass_expires_and_says_why" CHECK ((("role" <> 'support_break_glass'::"text") OR (("effective_until" IS NOT NULL) AND ("reason" IS NOT NULL)))),
    CONSTRAINT "membership_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'manager'::"text", 'operator'::"text", 'support_break_glass'::"text"]))),
    CONSTRAINT "membership_scope_is_whole" CHECK (((("scope_kind" = 'organization'::"text") AND ("organization_id" IS NOT NULL) AND ("location_id" IS NULL)) OR (("scope_kind" = 'shop'::"text") AND ("organization_id" IS NULL) AND ("location_id" IS NULL)) OR (("scope_kind" = 'location'::"text") AND ("organization_id" IS NULL) AND ("location_id" IS NOT NULL)))),
    CONSTRAINT "membership_scope_kind_check" CHECK (("scope_kind" = ANY (ARRAY['organization'::"text", 'shop'::"text", 'location'::"text"])))
);


--
-- Name: membership_revocation; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."membership_revocation" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "membership_id" "uuid" NOT NULL,
    "revoked_by" "uuid",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "membership_revocation_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: operator_pin; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."operator_pin" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "device_id" "uuid" NOT NULL,
    "app_user_id" "uuid" NOT NULL,
...
--
-- Name: operator_pin_retirement; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."operator_pin_retirement" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "operator_pin_id" "uuid" NOT NULL,
    "retired_pin_updated_at" timestamp with time zone NOT NULL,
    "membership_revocation_id" "uuid",
    "reason" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'system'::"text" NOT NULL,
    CONSTRAINT "operator_pin_retirement_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);
...
CREATE VIEW "public"."outbox_dead_letter" WITH ("security_invoker"='true') AS
...
CREATE VIEW "public"."pricing_snapshot_current" WITH ("security_invoker"='true') AS
 SELECT DISTINCT ON ("scan_session_id") "id",
    "scan_session_id",
    "shop_id",
    "source",
...
CREATE TABLE "public"."recovery_code" (
    ...
    "issued_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "recovery_code_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: recovery_code_use; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."recovery_code_use" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "app_user_id" "uuid" NOT NULL,
    "code_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "recovery_code_use_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);
...
CREATE TABLE "public"."shop" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "organization_id" "uuid",
    CONSTRAINT "shop_has_a_legal_party" CHECK (("organization_id" IS NOT NULL)),
    CONSTRAINT "shop_slug_charset" CHECK (("slug" ~ '^[a-z0-9-]+$'::"text"))
);


--
-- Name: shop_credential_retirement; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."shop_credential_retirement" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "credential_version_id" "uuid" NOT NULL,
    "reason_code" "text" NOT NULL,
    "retired_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "provider_revocation_instructed_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "shop_credential_retirement_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"])))
);


--
-- Name: shop_credential_version; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."shop_credential_version" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "kind" "text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "shop_credential_version_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "shop_credential_version_key_ref_check" CHECK (("key_ref" ~ '^LONGBOX_[A-Z0-9]+_(ANTHROPIC|OPENAI|SHOPIFY|PRICECHARTING|EBAY)_KEY(_SECRET)?$'::"text")),
    CONSTRAINT "shop_credential_version_kind_check" CHECK (("kind" = ANY (ARRAY['anthropic'::"text", 'openai_compat'::"text", 'shopify'::"text", 'pricecharting'::"text", 'ebay'::"text"]))),
    CONSTRAINT "shop_credential_version_version_no_check" CHECK (("version_no" >= 1))
);
...
--
-- Name: shop_recovery_nomination; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."shop_recovery_nomination" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shop_id" "uuid" NOT NULL,
    "kind" "text" NOT NULL,
    "contact_name" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "shop_recovery_nomination_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "shop_recovery_nomination_kind_check" CHECK (("kind" = ANY (ARRAY['second_owner'::"text", 'named_contact'::"text", 'declined'::"text"]))),
    CONSTRAINT "shop_recovery_nomination_shape" CHECK (((("kind" = 'named_contact'::"text") AND ("contact_name" IS NOT NULL)) OR (("kind" <> 'named_contact'::"text") AND ("contact_name" IS NULL) AND ("contact_note" IS NULL))))
);
...
--
-- Name: user_authenticator; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."user_authenticator" (
    "id" "uuid" NOT NULL,
    "app_user_id" "uuid" NOT NULL,
    "kind" "text" NOT NULL,
    ...
    "period_seconds" smallint DEFAULT 30 NOT NULL,
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "user_authenticator_algorithm_check" CHECK (("algorithm" = 'SHA1'::"text")),
    CONSTRAINT "user_authenticator_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "user_authenticator_digits_check" CHECK (("digits" = 6)),
    CONSTRAINT "user_authenticator_key_version_check" CHECK (("key_version" >= 1)),
    CONSTRAINT "user_authenticator_kind_check" CHECK (("kind" = 'totp'::"text")),
    CONSTRAINT "user_authenticator_period_seconds_check" CHECK (("period_seconds" = 30))
);


--
-- Name: user_authenticator_retirement; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."user_authenticator_retirement" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "app_user_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "user_authenticator_retirement_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "user_authenticator_retirement_reason_check" CHECK (("reason" = ANY (ARRAY['replaced'::"text", 'recovery_code_used'::"text", 'lost_authenticator'::"text", 'offboarding'::"text", 'compromise_suspected'::"text"])))
);
...
CREATE TABLE "public"."user_credential" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "authored_by" "text" DEFAULT 'human'::"text" NOT NULL,
    CONSTRAINT "user_credential_authored_by_check" CHECK (("authored_by" = ANY (ARRAY['human'::"text", 'system'::"text", 'provider'::"text"]))),
    CONSTRAINT "user_credential_pepper_version_check" CHECK (("pepper_version" >= 1))
);
...
--
-- Name: app_session app_session_chain_target; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_chain_target" UNIQUE ("id", "chain_id");


--
-- Name: app_session app_session_device_target; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_device_target" UNIQUE ("id", "device_id");


--
-- Name: app_session app_session_person_target; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_person_target" UNIQUE ("id", "app_user_id");
...
--
-- Name: app_session_revocation app_session_revocation_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session_revocation"
    ADD CONSTRAINT "app_session_revocation_pkey" PRIMARY KEY ("id");


--
-- Name: app_session app_session_rotated_from_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_rotated_from_key" UNIQUE ("rotated_from");


--
-- Name: app_session app_session_scope_target; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_scope_target" UNIQUE ("id", "app_user_id", "device_id");


--
-- Name: app_session app_session_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_token_hash_key" UNIQUE ("token_hash");
...
--
-- Name: app_user_origin app_user_origin_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin"
    ADD CONSTRAINT "app_user_origin_pkey" PRIMARY KEY ("id");


--
-- Name: app_user_origin_retirement app_user_origin_retirement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin_retirement"
    ADD CONSTRAINT "app_user_origin_retirement_pkey" PRIMARY KEY ("id");
...
--
-- Name: authorization_decision authorization_decision_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."authorization_decision"
...
--
-- Name: connector_install_state connector_install_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state"
    ADD CONSTRAINT "connector_install_state_pkey" PRIMARY KEY ("id");


--
-- Name: connector_install_state connector_install_state_state_digest_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state"
    ADD CONSTRAINT "connector_install_state_state_digest_key" UNIQUE ("state_digest");


--
-- Name: connector_install_state_use connector_install_state_use_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state_use"
    ADD CONSTRAINT "connector_install_state_use_pkey" PRIMARY KEY ("id");


--
-- Name: connector_token_retirement connector_token_retirement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_retirement"
    ADD CONSTRAINT "connector_token_retirement_pkey" PRIMARY KEY ("id");


--
-- Name: connector_token_version connector_token_version_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_version"
    ADD CONSTRAINT "connector_token_version_pkey" PRIMARY KEY ("id");


--
-- Name: connector_webhook_receipt connector_webhook_receipt_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_webhook_receipt"
    ADD CONSTRAINT "connector_webhook_receipt_pkey" PRIMARY KEY ("id");
...
--
-- Name: cost_log cost_log_has_a_spend_owner; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE "public"."cost_log"
    ADD CONSTRAINT "cost_log_has_a_spend_owner" CHECK ((("spend_owner" IS NOT NULL) AND ("spend_owner" = ANY (ARRAY['shop'::"text", 'longbox'::"text"])))) NOT VALID;
...
--
-- Name: device_credential device_credential_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential"
    ADD CONSTRAINT "device_credential_pkey" PRIMARY KEY ("id");


--
-- Name: device_credential_revocation device_credential_revocation_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential_revocation"
    ADD CONSTRAINT "device_credential_revocation_pkey" PRIMARY KEY ("id");


--
-- Name: device_credential device_credential_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential"
    ADD CONSTRAINT "device_credential_token_hash_key" UNIQUE ("token_hash");


--
-- Name: device_enrollment_code device_enrollment_code_code_digest_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code"
    ADD CONSTRAINT "device_enrollment_code_code_digest_key" UNIQUE ("code_digest");


--
-- Name: device_enrollment_code device_enrollment_code_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code"
    ADD CONSTRAINT "device_enrollment_code_pkey" PRIMARY KEY ("id");


--
-- Name: device_enrollment_code_use device_enrollment_code_use_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code_use"
    ADD CONSTRAINT "device_enrollment_code_use_pkey" PRIMARY KEY ("id");
...
--
-- Name: identity_access identity_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."identity_access"
    ADD CONSTRAINT "identity_access_pkey" PRIMARY KEY ("id");
...
--
-- Name: invitation_use invitation_use_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_pkey" PRIMARY KEY ("id");
...
--
-- Name: membership membership_break_glass_is_never_self_granted; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE "public"."membership"
    ADD CONSTRAINT "membership_break_glass_is_never_self_granted" CHECK ((("role" <> 'support_break_glass'::"text") OR ("granted_by" IS DISTINCT FROM "app_user_id"))) NOT VALID;
...
--
-- Name: membership_revocation membership_revocation_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership_revocation"
    ADD CONSTRAINT "membership_revocation_pkey" PRIMARY KEY ("id");


--
-- Name: operator_pin operator_pin_one_row_per_pair; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin"
    ADD CONSTRAINT "operator_pin_one_row_per_pair" UNIQUE ("device_id", "app_user_id");


--
-- Name: operator_pin operator_pin_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin"
    ADD CONSTRAINT "operator_pin_pkey" PRIMARY KEY ("id");


--
-- Name: operator_pin_retirement operator_pin_retirement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin_retirement"
    ADD CONSTRAINT "operator_pin_retirement_pkey" PRIMARY KEY ("id");
...
--
-- Name: recovery_code_use recovery_code_use_is_single_use; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."recovery_code_use"
    ADD CONSTRAINT "recovery_code_use_is_single_use" UNIQUE ("code_id");


--
-- Name: recovery_code_use recovery_code_use_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."recovery_code_use"
    ADD CONSTRAINT "recovery_code_use_pkey" PRIMARY KEY ("id");
...
--
-- Name: shop_credential_retirement shop_credential_retirement_credential_version_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_retirement"
    ADD CONSTRAINT "shop_credential_retirement_credential_version_id_key" UNIQUE ("credential_version_id");


--
-- Name: shop_credential_retirement shop_credential_retirement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_retirement"
    ADD CONSTRAINT "shop_credential_retirement_pkey" PRIMARY KEY ("id");


--
-- Name: shop_credential_version shop_credential_version_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_version"
    ADD CONSTRAINT "shop_credential_version_pkey" PRIMARY KEY ("id");


--
-- Name: shop_credential_version shop_credential_version_shop_id_kind_version_no_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_version"
    ADD CONSTRAINT "shop_credential_version_shop_id_kind_version_no_key" UNIQUE ("shop_id", "kind", "version_no");
...
--
-- Name: shop_recovery_nomination shop_recovery_nomination_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_recovery_nomination"
    ADD CONSTRAINT "shop_recovery_nomination_pkey" PRIMARY KEY ("id");
...
--
-- Name: user_authenticator user_authenticator_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator"
    ADD CONSTRAINT "user_authenticator_pkey" PRIMARY KEY ("id");


--
-- Name: user_authenticator_retirement user_authenticator_retirement_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator_retirement"
    ADD CONSTRAINT "user_authenticator_retirement_pkey" PRIMARY KEY ("id");


--
-- Name: user_credential user_credential_one_row_per_person; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_credential"
    ADD CONSTRAINT "user_credential_one_row_per_person" UNIQUE ("app_user_id");
...
--
-- Name: app_session_chain_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_session_chain_idx" ON "public"."app_session" USING "btree" ("chain_id");


--
-- Name: app_session_parent_chain_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_session_parent_chain_idx" ON "public"."app_session" USING "btree" ("parent_chain_id");


--
-- Name: app_session_revocation_chain_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "app_session_revocation_chain_idx" ON "public"."app_session_revocation" USING "btree" ("chain_id");


--
-- Name: app_session_revocation_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_session_revocation_shop_idx" ON "public"."app_session_revocation" USING "btree" ("shop_id");


--
-- Name: app_session_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_session_shop_idx" ON "public"."app_session" USING "btree" ("shop_id");


--
-- Name: app_session_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_session_user_idx" ON "public"."app_session" USING "btree" ("app_user_id", "chain_id");


--
-- Name: app_user_origin_retirement_origin_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "app_user_origin_retirement_origin_idx" ON "public"."app_user_origin_retirement" USING "btree" ("origin_id");


--
-- Name: app_user_origin_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "app_user_origin_user_idx" ON "public"."app_user_origin" USING "btree" ("app_user_id");


--
-- Name: auth_attempt_device_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "auth_attempt_device_idx" ON "public"."auth_attempt" USING "btree" ("device_id", "created_at" DESC);


--
-- Name: auth_attempt_pair_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "auth_attempt_pair_idx" ON "public"."auth_attempt" USING "btree" ("device_id", "app_user_id", "created_at" DESC);


--
-- Name: auth_attempt_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "auth_attempt_shop_idx" ON "public"."auth_attempt" USING "btree" ("shop_id");


--
-- Name: auth_attempt_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "auth_attempt_user_idx" ON "public"."auth_attempt" USING "btree" ("app_user_id", "method", "created_at" DESC);


--
-- Name: authorization_decision_shop_time_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "authorization_decision_shop_time_idx" ON "public"."authorization_decision" USING "btree" ("shop_id", "decided_at" DESC);
...
--
-- Name: candidate_set_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "candidate_set_shop_idx" ON "public"."candidate_set" USING "btree" ("shop_id");
...
--
-- Name: condition_assessment_against_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "condition_assessment_against_idx" ON "public"."condition_assessment" USING "btree" ("against_table", "against_id") WHERE ("against_table" IS NOT NULL);
...
--
-- Name: condition_assessment_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "condition_assessment_shop_idx" ON "public"."condition_assessment" USING "btree" ("shop_id");
...
--
-- Name: connector_install_state_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "connector_install_state_shop_idx" ON "public"."connector_install_state" USING "btree" ("shop_id", "created_at" DESC);


--
-- Name: connector_install_state_use_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "connector_install_state_use_shop_idx" ON "public"."connector_install_state_use" USING "btree" ("shop_id");


--
-- Name: connector_install_state_use_state_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "connector_install_state_use_state_idx" ON "public"."connector_install_state_use" USING "btree" ("state_id");


--
-- Name: connector_token_retirement_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "connector_token_retirement_shop_idx" ON "public"."connector_token_retirement" USING "btree" ("shop_id");


--
-- Name: connector_token_retirement_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "connector_token_retirement_version_idx" ON "public"."connector_token_retirement" USING "btree" ("connector_token_version_id");


--
-- Name: connector_token_version_lookup_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "connector_token_version_lookup_idx" ON "public"."connector_token_version" USING "btree" ("shop_id", "connector", "version_no" DESC);


--
-- Name: connector_token_version_no_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "connector_token_version_no_idx" ON "public"."connector_token_version" USING "btree" ("shop_id", "connector", "version_no");


--
-- Name: connector_webhook_receipt_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "connector_webhook_receipt_id_idx" ON "public"."connector_webhook_receipt" USING "btree" ("connector", "webhook_id");


--
-- Name: connector_webhook_receipt_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "connector_webhook_receipt_shop_idx" ON "public"."connector_webhook_receipt" USING "btree" ("shop_id", "received_at" DESC);


--
-- Name: cost_log_credential_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "cost_log_credential_version_idx" ON "public"."cost_log" USING "btree" ("credential_version_id") WHERE ("credential_version_id" IS NOT NULL);
...
--
-- Name: cost_log_spend_owner_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "cost_log_spend_owner_idx" ON "public"."cost_log" USING "btree" ("shop_id", "spend_owner", "created_at" DESC);


--
-- Name: device_credential_device_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_credential_device_idx" ON "public"."device_credential" USING "btree" ("device_id");


--
-- Name: device_credential_revocation_credential_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "device_credential_revocation_credential_idx" ON "public"."device_credential_revocation" USING "btree" ("credential_id");


--
-- Name: device_credential_revocation_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_credential_revocation_shop_idx" ON "public"."device_credential_revocation" USING "btree" ("shop_id");


--
-- Name: device_credential_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_credential_shop_idx" ON "public"."device_credential" USING "btree" ("shop_id");


--
-- Name: device_enrollment_code_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_enrollment_code_shop_idx" ON "public"."device_enrollment_code" USING "btree" ("shop_id", "created_at" DESC);


--
-- Name: device_enrollment_code_use_code_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "device_enrollment_code_use_code_idx" ON "public"."device_enrollment_code_use" USING "btree" ("code_id");


--
-- Name: device_enrollment_code_use_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_enrollment_code_use_shop_idx" ON "public"."device_enrollment_code_use" USING "btree" ("shop_id");


--
-- Name: device_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "device_shop_idx" ON "public"."device" USING "btree" ("shop_id");
...
--
-- Name: human_confirmation_against_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "human_confirmation_against_idx" ON "public"."human_confirmation" USING "btree" ("against_table", "against_id") WHERE ("against_table" IS NOT NULL);
...
--
-- Name: identity_access_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "identity_access_shop_idx" ON "public"."identity_access" USING "btree" ("shop_id");
...
--
-- Name: invitation_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "invitation_shop_idx" ON "public"."invitation" USING "btree" ("shop_id", "created_at" DESC);


--
-- Name: invitation_use_invitation_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "invitation_use_invitation_idx" ON "public"."invitation_use" USING "btree" ("invitation_id");


--
-- Name: invitation_use_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "invitation_use_shop_idx" ON "public"."invitation_use" USING "btree" ("shop_id");
...
--
-- Name: llm_rerank_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "llm_rerank_shop_idx" ON "public"."llm_rerank" USING "btree" ("shop_id");


--
-- Name: location_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "location_shop_idx" ON "public"."location" USING "btree" ("shop_id");
...
--
-- Name: membership_revocation_membership_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "membership_revocation_membership_idx" ON "public"."membership_revocation" USING "btree" ("membership_id");


--
-- Name: membership_revocation_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "membership_revocation_shop_idx" ON "public"."membership_revocation" USING "btree" ("shop_id");


--
-- Name: membership_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "membership_shop_idx" ON "public"."membership" USING "btree" ("shop_id");


--
-- Name: membership_user_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "membership_user_shop_idx" ON "public"."membership" USING "btree" ("app_user_id", "shop_id");


--
-- Name: operator_pin_device_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "operator_pin_device_idx" ON "public"."operator_pin" USING "btree" ("device_id");


--
-- Name: operator_pin_retirement_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "operator_pin_retirement_shop_idx" ON "public"."operator_pin_retirement" USING "btree" ("shop_id");


--
-- Name: operator_pin_retirement_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "operator_pin_retirement_version_idx" ON "public"."operator_pin_retirement" USING "btree" ("operator_pin_id", "retired_pin_updated_at");


--
-- Name: operator_pin_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "operator_pin_shop_idx" ON "public"."operator_pin" USING "btree" ("shop_id");
...
--
-- Name: pricing_snapshot_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "pricing_snapshot_shop_idx" ON "public"."pricing_snapshot" USING "btree" ("shop_id");
...
--
-- Name: recovery_code_batch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "recovery_code_batch_idx" ON "public"."recovery_code" USING "btree" ("batch_id");


--
-- Name: recovery_code_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "recovery_code_user_idx" ON "public"."recovery_code" USING "btree" ("app_user_id", "issued_at" DESC);
...
--
-- Name: scan_photo_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "scan_photo_shop_idx" ON "public"."scan_photo" USING "btree" ("shop_id");
...
--
-- Name: scan_session_scope_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "scan_session_scope_key" ON "public"."scan_session" USING "btree" ("id", "shop_id");
...
--
-- Name: shop_credential_retirement_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "shop_credential_retirement_shop_idx" ON "public"."shop_credential_retirement" USING "btree" ("shop_id", "retired_at" DESC);


--
-- Name: shop_credential_retirement_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "shop_credential_retirement_version_idx" ON "public"."shop_credential_retirement" USING "btree" ("credential_version_id");


--
-- Name: shop_credential_version_lookup_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "shop_credential_version_lookup_idx" ON "public"."shop_credential_version" USING "btree" ("shop_id", "kind", "version_no" DESC);
...
--
-- Name: shop_recovery_nomination_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "shop_recovery_nomination_shop_idx" ON "public"."shop_recovery_nomination" USING "btree" ("shop_id", "created_at" DESC);


--
-- Name: shop_shopify_domain_is_one_store; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "shop_shopify_domain_is_one_store" ON "public"."shop" USING "btree" ("shopify_domain") WHERE ("shopify_domain" IS NOT NULL);
...
--
-- Name: shopify_draft_shop_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "shopify_draft_shop_idx" ON "public"."shopify_draft" USING "btree" ("shop_id");


--
-- Name: user_authenticator_retirement_one_ending_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "user_authenticator_retirement_one_ending_idx" ON "public"."user_authenticator_retirement" USING "btree" ("authenticator_id");


--
-- Name: user_authenticator_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "user_authenticator_user_idx" ON "public"."user_authenticator" USING "btree" ("app_user_id", "enrolled_at" DESC);
...
--
-- Name: app_user_origin a_app_user_origin_not_future; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "a_app_user_origin_not_future" BEFORE INSERT ON "public"."app_user_origin" FOR EACH ROW EXECUTE FUNCTION "public"."check_origin_designation_window"();

ALTER TABLE "public"."app_user_origin" ENABLE ALWAYS TRIGGER "a_app_user_origin_not_future";


--
-- Name: app_user_origin_retirement a_app_user_origin_retirement_forces_now; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "a_app_user_origin_retirement_forces_now" BEFORE INSERT ON "public"."app_user_origin_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."force_origin_retirement_now"();

ALTER TABLE "public"."app_user_origin_retirement" ENABLE ALWAYS TRIGGER "a_app_user_origin_retirement_forces_now";


--
-- Name: app_session app_session_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "app_session_append_only" BEFORE DELETE OR UPDATE ON "public"."app_session" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."app_session" ENABLE ALWAYS TRIGGER "app_session_append_only";


--
-- Name: app_session_revocation app_session_revocation_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "app_session_revocation_append_only" BEFORE DELETE OR UPDATE ON "public"."app_session_revocation" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."app_session_revocation" ENABLE ALWAYS TRIGGER "app_session_revocation_append_only";


--
-- Name: app_user_origin app_user_origin_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "app_user_origin_append_only" BEFORE DELETE OR UPDATE ON "public"."app_user_origin" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."app_user_origin" ENABLE ALWAYS TRIGGER "app_user_origin_append_only";


--
-- Name: app_user_origin_retirement app_user_origin_retirement_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "app_user_origin_retirement_append_only" BEFORE DELETE OR UPDATE ON "public"."app_user_origin_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."app_user_origin_retirement" ENABLE ALWAYS TRIGGER "app_user_origin_retirement_append_only";


--
-- Name: auth_attempt auth_attempt_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "auth_attempt_append_only" BEFORE DELETE OR UPDATE ON "public"."auth_attempt" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."auth_attempt" ENABLE ALWAYS TRIGGER "auth_attempt_append_only";


--
-- Name: authorization_decision authorization_decision_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "authorization_decision_append_only" BEFORE DELETE OR UPDATE ON "public"."authorization_decision" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."authorization_decision" ENABLE ALWAYS TRIGGER "authorization_decision_append_only";


--
-- Name: app_user_origin_retirement b_app_user_origin_retirement_not_before_start; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "b_app_user_origin_retirement_not_before_start" BEFORE INSERT ON "public"."app_user_origin_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."check_origin_designation_window"();

ALTER TABLE "public"."app_user_origin_retirement" ENABLE ALWAYS TRIGGER "b_app_user_origin_retirement_not_before_start";
...
--
-- Name: connector_install_state connector_install_state_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "connector_install_state_append_only" BEFORE DELETE OR UPDATE ON "public"."connector_install_state" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."connector_install_state" ENABLE ALWAYS TRIGGER "connector_install_state_append_only";


--
-- Name: connector_install_state_use connector_install_state_use_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "connector_install_state_use_append_only" BEFORE DELETE OR UPDATE ON "public"."connector_install_state_use" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."connector_install_state_use" ENABLE ALWAYS TRIGGER "connector_install_state_use_append_only";


--
-- Name: connector_token_retirement connector_token_retirement_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "connector_token_retirement_append_only" BEFORE DELETE OR UPDATE ON "public"."connector_token_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."connector_token_retirement" ENABLE ALWAYS TRIGGER "connector_token_retirement_append_only";


--
-- Name: connector_token_version connector_token_version_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "connector_token_version_append_only" BEFORE DELETE OR UPDATE ON "public"."connector_token_version" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."connector_token_version" ENABLE ALWAYS TRIGGER "connector_token_version_append_only";


--
-- Name: connector_webhook_receipt connector_webhook_receipt_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "connector_webhook_receipt_append_only" BEFORE DELETE OR UPDATE ON "public"."connector_webhook_receipt" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."connector_webhook_receipt" ENABLE ALWAYS TRIGGER "connector_webhook_receipt_append_only";
...
--
-- Name: device_credential device_credential_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "device_credential_append_only" BEFORE DELETE OR UPDATE ON "public"."device_credential" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."device_credential" ENABLE ALWAYS TRIGGER "device_credential_append_only";


--
-- Name: device_credential_revocation device_credential_revocation_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "device_credential_revocation_append_only" BEFORE DELETE OR UPDATE ON "public"."device_credential_revocation" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."device_credential_revocation" ENABLE ALWAYS TRIGGER "device_credential_revocation_append_only";


--
-- Name: device_enrollment_code device_enrollment_code_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "device_enrollment_code_append_only" BEFORE DELETE OR UPDATE ON "public"."device_enrollment_code" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."device_enrollment_code" ENABLE ALWAYS TRIGGER "device_enrollment_code_append_only";


--
-- Name: device_enrollment_code_use device_enrollment_code_use_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "device_enrollment_code_use_append_only" BEFORE DELETE OR UPDATE ON "public"."device_enrollment_code_use" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."device_enrollment_code_use" ENABLE ALWAYS TRIGGER "device_enrollment_code_use_append_only";
...
--
-- Name: identity_access identity_access_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "identity_access_append_only" BEFORE DELETE OR UPDATE ON "public"."identity_access" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."identity_access" ENABLE ALWAYS TRIGGER "identity_access_append_only";
...
--
-- Name: invitation invitation_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "invitation_append_only" BEFORE DELETE OR UPDATE ON "public"."invitation" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."invitation" ENABLE ALWAYS TRIGGER "invitation_append_only";


--
-- Name: invitation_use invitation_use_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "invitation_use_append_only" BEFORE DELETE OR UPDATE ON "public"."invitation_use" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."invitation_use" ENABLE ALWAYS TRIGGER "invitation_use_append_only";
...
--
-- Name: membership membership_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "membership_append_only" BEFORE DELETE OR UPDATE ON "public"."membership" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."membership" ENABLE ALWAYS TRIGGER "membership_append_only";


--
-- Name: membership_revocation membership_revocation_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "membership_revocation_append_only" BEFORE DELETE OR UPDATE ON "public"."membership_revocation" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."membership_revocation" ENABLE ALWAYS TRIGGER "membership_revocation_append_only";


--
-- Name: operator_pin_retirement operator_pin_retirement_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "operator_pin_retirement_append_only" BEFORE DELETE OR UPDATE ON "public"."operator_pin_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."operator_pin_retirement" ENABLE ALWAYS TRIGGER "operator_pin_retirement_append_only";
...
--
-- Name: recovery_code recovery_code_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "recovery_code_append_only" BEFORE DELETE OR UPDATE ON "public"."recovery_code" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."recovery_code" ENABLE ALWAYS TRIGGER "recovery_code_append_only";


--
-- Name: recovery_code_use recovery_code_use_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "recovery_code_use_append_only" BEFORE DELETE OR UPDATE ON "public"."recovery_code_use" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."recovery_code_use" ENABLE ALWAYS TRIGGER "recovery_code_use_append_only";
...
--
-- Name: shop_credential_retirement shop_credential_retirement_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "shop_credential_retirement_append_only" BEFORE DELETE OR UPDATE ON "public"."shop_credential_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."shop_credential_retirement" ENABLE ALWAYS TRIGGER "shop_credential_retirement_append_only";


--
-- Name: shop_credential_version shop_credential_version_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "shop_credential_version_append_only" BEFORE DELETE OR UPDATE ON "public"."shop_credential_version" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."shop_credential_version" ENABLE ALWAYS TRIGGER "shop_credential_version_append_only";


--
-- Name: shop_recovery_nomination shop_recovery_nomination_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "shop_recovery_nomination_append_only" BEFORE DELETE OR UPDATE ON "public"."shop_recovery_nomination" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."shop_recovery_nomination" ENABLE ALWAYS TRIGGER "shop_recovery_nomination_append_only";
...
--
-- Name: user_authenticator_retirement user_authenticator_retirement_append_only; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "user_authenticator_retirement_append_only" BEFORE DELETE OR UPDATE ON "public"."user_authenticator_retirement" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_mutation"();

ALTER TABLE "public"."user_authenticator_retirement" ENABLE ALWAYS TRIGGER "user_authenticator_retirement_append_only";


--
-- Name: user_authenticator user_authenticator_step_is_monotone; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "user_authenticator_step_is_monotone" BEFORE DELETE OR UPDATE ON "public"."user_authenticator" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_authenticator_mutation"();

ALTER TABLE "public"."user_authenticator" ENABLE ALWAYS TRIGGER "user_authenticator_step_is_monotone";


--
-- Name: user_credential user_credential_scoped_mutation; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "user_credential_scoped_mutation" BEFORE DELETE OR UPDATE ON "public"."user_credential" FOR EACH ROW EXECUTE FUNCTION "public"."forbid_credential_mutation"();

ALTER TABLE "public"."user_credential" ENABLE ALWAYS TRIGGER "user_credential_scoped_mutation";
...
--
-- Name: app_session app_session_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: app_session app_session_device_credential_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_device_credential_id_fkey" FOREIGN KEY ("device_credential_id") REFERENCES "public"."device_credential"("id");


--
-- Name: app_session app_session_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."device"("id");


--
-- Name: app_session app_session_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location"("id");


--
-- Name: app_session app_session_parent_pair_is_one_fact; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_parent_pair_is_one_fact" FOREIGN KEY ("parent_session_id", "parent_chain_id") REFERENCES "public"."app_session"("id", "chain_id");


--
-- Name: app_session app_session_parent_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_parent_session_id_fkey" FOREIGN KEY ("parent_session_id") REFERENCES "public"."app_session"("id");


--
-- Name: app_session_revocation app_session_revocation_revoked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session_revocation"
    ADD CONSTRAINT "app_session_revocation_revoked_by_fkey" FOREIGN KEY ("revoked_by") REFERENCES "public"."app_user"("id");


--
-- Name: app_session_revocation app_session_revocation_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session_revocation"
    ADD CONSTRAINT "app_session_revocation_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: app_session app_session_rotated_from_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_rotated_from_fkey" FOREIGN KEY ("rotated_from") REFERENCES "public"."app_session"("id");


--
-- Name: app_session app_session_rotation_keeps_its_device; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_rotation_keeps_its_device" FOREIGN KEY ("rotated_from", "device_id") REFERENCES "public"."app_session"("id", "device_id");


--
-- Name: app_session app_session_rotation_keeps_its_person; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_rotation_keeps_its_person" FOREIGN KEY ("rotated_from", "app_user_id") REFERENCES "public"."app_session"("id", "app_user_id");


--
-- Name: app_session app_session_rotation_keeps_its_principal; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_rotation_keeps_its_principal" FOREIGN KEY ("rotated_from", "app_user_id", "device_id") REFERENCES "public"."app_session"("id", "app_user_id", "device_id");


--
-- Name: app_session app_session_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_session"
    ADD CONSTRAINT "app_session_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: app_user_origin app_user_origin_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin"
    ADD CONSTRAINT "app_user_origin_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: app_user_origin app_user_origin_designated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin"
    ADD CONSTRAINT "app_user_origin_designated_by_fkey" FOREIGN KEY ("designated_by") REFERENCES "public"."app_user"("id");


--
-- Name: app_user_origin_retirement app_user_origin_retirement_origin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin_retirement"
    ADD CONSTRAINT "app_user_origin_retirement_origin_id_fkey" FOREIGN KEY ("origin_id") REFERENCES "public"."app_user_origin"("id");


--
-- Name: app_user_origin_retirement app_user_origin_retirement_retired_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."app_user_origin_retirement"
    ADD CONSTRAINT "app_user_origin_retirement_retired_by_fkey" FOREIGN KEY ("retired_by") REFERENCES "public"."app_user"("id");


--
-- Name: auth_attempt auth_attempt_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."auth_attempt"
    ADD CONSTRAINT "auth_attempt_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: auth_attempt auth_attempt_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."auth_attempt"
    ADD CONSTRAINT "auth_attempt_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."device"("id");


--
-- Name: auth_attempt auth_attempt_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."auth_attempt"
    ADD CONSTRAINT "auth_attempt_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: authorization_decision authorization_decision_membership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."authorization_decision"
    ADD CONSTRAINT "authorization_decision_membership_id_fkey" FOREIGN KEY ("membership_id") REFERENCES "public"."membership"("id");


--
-- Name: authorization_decision authorization_decision_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."authorization_decision"
    ADD CONSTRAINT "authorization_decision_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: candidate_set candidate_set_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."candidate_set"
    ADD CONSTRAINT "candidate_set_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: condition_assessment condition_assessment_operator_is_an_app_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."condition_assessment"
    ADD CONSTRAINT "condition_assessment_operator_is_an_app_user" FOREIGN KEY ("operator_id") REFERENCES "public"."app_user"("id");


--
-- Name: condition_assessment condition_assessment_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."condition_assessment"
    ADD CONSTRAINT "condition_assessment_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: connector_install_state connector_install_state_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state"
    ADD CONSTRAINT "connector_install_state_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: connector_install_state_use connector_install_state_use_connector_token_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state_use"
    ADD CONSTRAINT "connector_install_state_use_connector_token_version_id_fkey" FOREIGN KEY ("connector_token_version_id") REFERENCES "public"."connector_token_version"("id");


--
-- Name: connector_install_state_use connector_install_state_use_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state_use"
    ADD CONSTRAINT "connector_install_state_use_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: connector_install_state_use connector_install_state_use_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_install_state_use"
    ADD CONSTRAINT "connector_install_state_use_state_id_fkey" FOREIGN KEY ("state_id") REFERENCES "public"."connector_install_state"("id");


--
-- Name: connector_token_retirement connector_token_retirement_connector_token_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_retirement"
    ADD CONSTRAINT "connector_token_retirement_connector_token_version_id_fkey" FOREIGN KEY ("connector_token_version_id") REFERENCES "public"."connector_token_version"("id");


--
-- Name: connector_token_retirement connector_token_retirement_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_retirement"
    ADD CONSTRAINT "connector_token_retirement_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: connector_token_retirement connector_token_retirement_webhook_receipt_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_retirement"
    ADD CONSTRAINT "connector_token_retirement_webhook_receipt_id_fkey" FOREIGN KEY ("webhook_receipt_id") REFERENCES "public"."connector_webhook_receipt"("id");


--
-- Name: connector_token_version connector_token_version_install_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_version"
    ADD CONSTRAINT "connector_token_version_install_state_id_fkey" FOREIGN KEY ("install_state_id") REFERENCES "public"."connector_install_state"("id");


--
-- Name: connector_token_version connector_token_version_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_token_version"
    ADD CONSTRAINT "connector_token_version_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: connector_webhook_receipt connector_webhook_receipt_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."connector_webhook_receipt"
    ADD CONSTRAINT "connector_webhook_receipt_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: cost_log cost_log_credential_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."cost_log"
    ADD CONSTRAINT "cost_log_credential_version_id_fkey" FOREIGN KEY ("credential_version_id") REFERENCES "public"."shop_credential_version"("id");
...
--
-- Name: cost_log cost_log_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."cost_log"
    ADD CONSTRAINT "cost_log_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: device_credential device_credential_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential"
    ADD CONSTRAINT "device_credential_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."device"("id");


--
-- Name: device_credential device_credential_enrolled_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential"
    ADD CONSTRAINT "device_credential_enrolled_by_fkey" FOREIGN KEY ("enrolled_by") REFERENCES "public"."app_user"("id");


--
-- Name: device_credential_revocation device_credential_revocation_credential_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential_revocation"
    ADD CONSTRAINT "device_credential_revocation_credential_id_fkey" FOREIGN KEY ("credential_id") REFERENCES "public"."device_credential"("id");


--
-- Name: device_credential_revocation device_credential_revocation_revoked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential_revocation"
    ADD CONSTRAINT "device_credential_revocation_revoked_by_fkey" FOREIGN KEY ("revoked_by") REFERENCES "public"."app_user"("id");


--
-- Name: device_credential_revocation device_credential_revocation_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential_revocation"
    ADD CONSTRAINT "device_credential_revocation_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: device_credential device_credential_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_credential"
    ADD CONSTRAINT "device_credential_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: device_enrollment_code device_enrollment_code_issued_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code"
    ADD CONSTRAINT "device_enrollment_code_issued_by_fkey" FOREIGN KEY ("issued_by") REFERENCES "public"."app_user"("id");


--
-- Name: device_enrollment_code device_enrollment_code_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code"
    ADD CONSTRAINT "device_enrollment_code_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location"("id");


--
-- Name: device_enrollment_code device_enrollment_code_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code"
    ADD CONSTRAINT "device_enrollment_code_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: device_enrollment_code_use device_enrollment_code_use_code_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code_use"
    ADD CONSTRAINT "device_enrollment_code_use_code_id_fkey" FOREIGN KEY ("code_id") REFERENCES "public"."device_enrollment_code"("id");


--
-- Name: device_enrollment_code_use device_enrollment_code_use_device_credential_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code_use"
    ADD CONSTRAINT "device_enrollment_code_use_device_credential_id_fkey" FOREIGN KEY ("device_credential_id") REFERENCES "public"."device_credential"("id");


--
-- Name: device_enrollment_code_use device_enrollment_code_use_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code_use"
    ADD CONSTRAINT "device_enrollment_code_use_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."device"("id");


--
-- Name: device_enrollment_code_use device_enrollment_code_use_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device_enrollment_code_use"
    ADD CONSTRAINT "device_enrollment_code_use_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: device device_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: device device_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."device"
    ADD CONSTRAINT "device_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: human_confirmation human_confirmation_operator_is_an_app_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."human_confirmation"
    ADD CONSTRAINT "human_confirmation_operator_is_an_app_user" FOREIGN KEY ("operator_id") REFERENCES "public"."app_user"("id");


--
-- Name: human_confirmation human_confirmation_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."human_confirmation"
    ADD CONSTRAINT "human_confirmation_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: identity_access identity_access_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."identity_access"
    ADD CONSTRAINT "identity_access_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: invitation invitation_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");
...
ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "public"."app_user"("id");


--
-- Name: invitation invitation_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location"("id");


--
-- Name: invitation invitation_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation"
    ADD CONSTRAINT "invitation_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: invitation_use invitation_use_invitation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_invitation_id_fkey" FOREIGN KEY ("invitation_id") REFERENCES "public"."invitation"("id");


--
-- Name: invitation_use invitation_use_membership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_membership_id_fkey" FOREIGN KEY ("membership_id") REFERENCES "public"."membership"("id");


--
-- Name: invitation_use invitation_use_redeemed_on_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_redeemed_on_device_id_fkey" FOREIGN KEY ("redeemed_on_device_id") REFERENCES "public"."device"("id");


--
-- Name: invitation_use invitation_use_redeemed_on_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_redeemed_on_session_id_fkey" FOREIGN KEY ("redeemed_on_session_id") REFERENCES "public"."app_session"("id");


--
-- Name: invitation_use invitation_use_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."invitation_use"
    ADD CONSTRAINT "invitation_use_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: llm_rerank llm_rerank_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."llm_rerank"
    ADD CONSTRAINT "llm_rerank_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
ALTER TABLE ONLY "public"."location"
    ADD CONSTRAINT "location_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: membership membership_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership"
    ADD CONSTRAINT "membership_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: membership membership_granted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership"
    ADD CONSTRAINT "membership_granted_by_fkey" FOREIGN KEY ("granted_by") REFERENCES "public"."app_user"("id");


--
-- Name: membership membership_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership"
    ADD CONSTRAINT "membership_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."location"("id");


--
-- Name: membership membership_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership"
    ADD CONSTRAINT "membership_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id");


--
-- Name: membership_revocation membership_revocation_membership_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership_revocation"
    ADD CONSTRAINT "membership_revocation_membership_id_fkey" FOREIGN KEY ("membership_id") REFERENCES "public"."membership"("id");


--
-- Name: membership_revocation membership_revocation_revoked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership_revocation"
    ADD CONSTRAINT "membership_revocation_revoked_by_fkey" FOREIGN KEY ("revoked_by") REFERENCES "public"."app_user"("id");


--
-- Name: membership_revocation membership_revocation_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership_revocation"
    ADD CONSTRAINT "membership_revocation_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: membership membership_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."membership"
    ADD CONSTRAINT "membership_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: operator_pin operator_pin_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin"
    ADD CONSTRAINT "operator_pin_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: operator_pin operator_pin_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin"
    ADD CONSTRAINT "operator_pin_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."device"("id");


--
-- Name: operator_pin_retirement operator_pin_retirement_membership_revocation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin_retirement"
    ADD CONSTRAINT "operator_pin_retirement_membership_revocation_id_fkey" FOREIGN KEY ("membership_revocation_id") REFERENCES "public"."membership_revocation"("id");


--
-- Name: operator_pin_retirement operator_pin_retirement_operator_pin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin_retirement"
    ADD CONSTRAINT "operator_pin_retirement_operator_pin_id_fkey" FOREIGN KEY ("operator_pin_id") REFERENCES "public"."operator_pin"("id");


--
-- Name: operator_pin_retirement operator_pin_retirement_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin_retirement"
    ADD CONSTRAINT "operator_pin_retirement_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: operator_pin operator_pin_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."operator_pin"
    ADD CONSTRAINT "operator_pin_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: outbox outbox_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."outbox"
    ADD CONSTRAINT "outbox_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: pricing_snapshot pricing_snapshot_operator_is_an_app_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."pricing_snapshot"
    ADD CONSTRAINT "pricing_snapshot_operator_is_an_app_user" FOREIGN KEY ("operator_id") REFERENCES "public"."app_user"("id");
...
--
-- Name: pricing_snapshot pricing_snapshot_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."pricing_snapshot"
    ADD CONSTRAINT "pricing_snapshot_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: recovery_code recovery_code_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."recovery_code"
    ADD CONSTRAINT "recovery_code_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: recovery_code_use recovery_code_use_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."recovery_code_use"
    ADD CONSTRAINT "recovery_code_use_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: recovery_code_use recovery_code_use_code_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."recovery_code_use"
    ADD CONSTRAINT "recovery_code_use_code_id_fkey" FOREIGN KEY ("code_id") REFERENCES "public"."recovery_code"("id");
...
--
-- Name: scan_photo scan_photo_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."scan_photo"
    ADD CONSTRAINT "scan_photo_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: scan_session scan_session_operator_is_an_app_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."scan_session"
    ADD CONSTRAINT "scan_session_operator_is_an_app_user" FOREIGN KEY ("operator_id") REFERENCES "public"."app_user"("id");
...
--
-- Name: scan_session_transition scan_session_transition_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."scan_session_transition"
    ADD CONSTRAINT "scan_session_transition_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: shop_credential_retirement shop_credential_retirement_credential_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_retirement"
    ADD CONSTRAINT "shop_credential_retirement_credential_version_id_fkey" FOREIGN KEY ("credential_version_id") REFERENCES "public"."shop_credential_version"("id");


--
-- Name: shop_credential_retirement shop_credential_retirement_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_retirement"
    ADD CONSTRAINT "shop_credential_retirement_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");


--
-- Name: shop_credential_version shop_credential_version_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_credential_version"
    ADD CONSTRAINT "shop_credential_version_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
ALTER TABLE ONLY "public"."shop"
    ADD CONSTRAINT "shop_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id");
...
--
-- Name: shop_recovery_nomination shop_recovery_nomination_nominated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_recovery_nomination"
    ADD CONSTRAINT "shop_recovery_nomination_nominated_by_fkey" FOREIGN KEY ("nominated_by") REFERENCES "public"."app_user"("id");


--
-- Name: shop_recovery_nomination shop_recovery_nomination_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shop_recovery_nomination"
    ADD CONSTRAINT "shop_recovery_nomination_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "public"."shop"("id");
...
--
-- Name: shopify_draft shopify_draft_session_same_shop; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."shopify_draft"
    ADD CONSTRAINT "shopify_draft_session_same_shop" FOREIGN KEY ("scan_session_id", "shop_id") REFERENCES "public"."scan_session"("id", "shop_id");
...
--
-- Name: user_authenticator user_authenticator_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator"
    ADD CONSTRAINT "user_authenticator_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: user_authenticator_retirement user_authenticator_retirement_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator_retirement"
    ADD CONSTRAINT "user_authenticator_retirement_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");


--
-- Name: user_authenticator_retirement user_authenticator_retirement_authenticator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator_retirement"
    ADD CONSTRAINT "user_authenticator_retirement_authenticator_id_fkey" FOREIGN KEY ("authenticator_id") REFERENCES "public"."user_authenticator"("id");


--
-- Name: user_authenticator_retirement user_authenticator_retirement_retired_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_authenticator_retirement"
    ADD CONSTRAINT "user_authenticator_retirement_retired_by_fkey" FOREIGN KEY ("retired_by") REFERENCES "public"."app_user"("id");


--
-- Name: user_credential user_credential_app_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_credential"
    ADD CONSTRAINT "user_credential_app_user_id_fkey" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_user"("id");
...
--
-- Name: app_session_revocation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."app_session_revocation" ENABLE ROW LEVEL SECURITY;

--
-- Name: auth_attempt; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."auth_attempt" ENABLE ROW LEVEL SECURITY;

--
-- Name: authorization_decision; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."authorization_decision" ENABLE ROW LEVEL SECURITY;

--
-- Name: candidate_set; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."candidate_set" ENABLE ROW LEVEL SECURITY;

--
-- Name: condition_assessment; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."condition_assessment" ENABLE ROW LEVEL SECURITY;

--
-- Name: connector_install_state; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."connector_install_state" ENABLE ROW LEVEL SECURITY;

--
-- Name: connector_install_state_use; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."connector_install_state_use" ENABLE ROW LEVEL SECURITY;

--
-- Name: connector_token_retirement; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."connector_token_retirement" ENABLE ROW LEVEL SECURITY;

--
-- Name: connector_token_version; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."connector_token_version" ENABLE ROW LEVEL SECURITY;

--
-- Name: connector_webhook_receipt; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."connector_webhook_receipt" ENABLE ROW LEVEL SECURITY;

--
-- Name: cost_log; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: device_credential; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."device_credential" ENABLE ROW LEVEL SECURITY;

--
-- Name: device_credential_revocation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."device_credential_revocation" ENABLE ROW LEVEL SECURITY;

--
-- Name: device_enrollment_code; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."device_enrollment_code" ENABLE ROW LEVEL SECURITY;

--
-- Name: device_enrollment_code_use; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."device_enrollment_code_use" ENABLE ROW LEVEL SECURITY;

--
-- Name: human_confirmation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."human_confirmation" ENABLE ROW LEVEL SECURITY;

--
-- Name: identity_resolution; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: invitation_use; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."invitation_use" ENABLE ROW LEVEL SECURITY;

--
-- Name: listing_status_observation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."listing_status_observation" ENABLE ROW LEVEL SECURITY;

--
-- Name: llm_rerank; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."llm_rerank" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: media_deletion; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: membership_revocation; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."membership_revocation" ENABLE ROW LEVEL SECURITY;

--
-- Name: operator_pin; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."operator_pin" ENABLE ROW LEVEL SECURITY;

--
-- Name: operator_pin_retirement; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."operator_pin_retirement" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: outbox_attempt; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."outbox_attempt" ENABLE ROW LEVEL SECURITY;

--
-- Name: pricing_snapshot; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: retention_hold; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: scan_photo; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."scan_photo" ENABLE ROW LEVEL SECURITY;

--
-- Name: scan_session; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."scan_session" ENABLE ROW LEVEL SECURITY;

--
-- Name: scan_session_transition; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."scan_session_transition" ENABLE ROW LEVEL SECURITY;

--
-- Name: shop_credential_retirement; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shop_credential_retirement" ENABLE ROW LEVEL SECURITY;

--
-- Name: shop_credential_version; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shop_credential_version" ENABLE ROW LEVEL SECURITY;

--
-- Name: shop_credentials; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shop_credentials" ENABLE ROW LEVEL SECURITY;

--
-- Name: shop_pricing_policy; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shop_pricing_policy" ENABLE ROW LEVEL SECURITY;

--
-- Name: shop_recovery_nomination; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shop_recovery_nomination" ENABLE ROW LEVEL SECURITY;

--
-- Name: shopify_draft; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."shopify_draft" ENABLE ROW LEVEL SECURITY;

--
-- Name: app_session tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."app_session" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: app_session_revocation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."app_session_revocation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: auth_attempt tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."auth_attempt" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: authorization_decision tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."authorization_decision" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: candidate_set tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."candidate_set" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: condition_assessment tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."condition_assessment" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: connector_install_state tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."connector_install_state" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: connector_install_state_use tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."connector_install_state_use" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: connector_token_retirement tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."connector_token_retirement" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: connector_token_version tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."connector_token_version" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: connector_webhook_receipt tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."connector_webhook_receipt" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: cost_log tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."cost_log" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: device tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."device" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: device_credential tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."device_credential" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: device_credential_revocation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."device_credential_revocation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: device_enrollment_code tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."device_enrollment_code" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: device_enrollment_code_use tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."device_enrollment_code_use" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: human_confirmation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."human_confirmation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: identity_resolution tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."identity_resolution" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: invitation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."invitation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: invitation_use tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."invitation_use" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: listing_status_observation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."listing_status_observation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: llm_rerank tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."llm_rerank" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: location tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."location" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: media_deletion tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."media_deletion" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));
...
CREATE POLICY "tenant_isolation" ON "public"."membership" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: membership_revocation tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."membership_revocation" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: operator_pin tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."operator_pin" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: operator_pin_retirement tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."operator_pin_retirement" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));
...
CREATE POLICY "tenant_isolation" ON "public"."outbox" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: outbox_attempt tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."outbox_attempt" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: pricing_snapshot tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."pricing_snapshot" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: request_idempotency tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."request_idempotency" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: retention_hold tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."retention_hold" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: retention_policy tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."retention_policy" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: scan_photo tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."scan_photo" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: scan_session tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."scan_session" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: scan_session_transition tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."scan_session_transition" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shop_credential_retirement tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shop_credential_retirement" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shop_credential_version tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shop_credential_version" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shop_credentials tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shop_credentials" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shop_pricing_policy tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shop_pricing_policy" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shop_recovery_nomination tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shop_recovery_nomination" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));


--
-- Name: shopify_draft tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant_isolation" ON "public"."shopify_draft" USING (("shop_id" = "public"."current_shop_id"())) WITH CHECK (("shop_id" = "public"."current_shop_id"()));
...
\unrestrict SInuFSEx8hXbPsXwcflkY5jWEuqgXZjIFTM57T4sXmJiAgqosN33dZcAUZm4HJN
